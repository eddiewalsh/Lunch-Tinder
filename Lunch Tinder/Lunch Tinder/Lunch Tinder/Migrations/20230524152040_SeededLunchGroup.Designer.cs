...
namespace Lunch_Tinder.Migrations
{
    ...
    [Migration("20230524152040_SeededLunchGroup")]
    partial class SeededLunchGroup
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lunch_Tinder.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2023, 5, 24, 15, 25, 40, 258, DateTimeKind.Utc).AddTicks(6871),
                            Name = "Locke Burger",
                            StartTime = new DateTime(2023, 5, 24, 15, 20, 40, 258, DateTimeKind.Utc).AddTicks(6870)
                        });
                });
