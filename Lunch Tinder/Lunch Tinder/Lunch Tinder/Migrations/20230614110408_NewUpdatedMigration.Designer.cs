...
namespace Lunch_Tinder.Migrations
{
    ...
    [Migration("20230614110408_NewUpdatedMigration")]
            ...
            modelBuilder.Entity("Lunch_Tinder.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2023, 6, 14, 11, 9, 8, 390, DateTimeKind.Utc).AddTicks(4985),
                            Name = "Locke Burger",
                            StartTime = new DateTime(2023, 6, 14, 11, 4, 8, 390, DateTimeKind.Utc).AddTicks(4982)
                        });
                });
            ...
            modelBuilder.Entity("Lunch_Tinder.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$v1koGsyI6gemgs1oM5jqz.9/kUF2dy.n4oYnKfddjD6OBO0TZs/1q",
                            UserName = "Test",
                            UserType = "USER"
                        },
                        new
                        {
                            ...
                            Password = "$2a$11$oFgvjLYt2PQYJ8tg/YLoGukFlLHoE9y80QvuM.DpNUQmCkmPeNLUi",
                            UserName = "Test",
                            UserType = "ADMIN"
                        });
                });
