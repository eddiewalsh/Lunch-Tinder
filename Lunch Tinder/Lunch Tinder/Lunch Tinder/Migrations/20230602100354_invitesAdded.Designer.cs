...
namespace Lunch_Tinder.Migrations
{
    ...
    [Migration("20230602100354_invitesAdded")]
    partial class invitesAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lunch_Tinder.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2023, 6, 2, 10, 8, 53, 961, DateTimeKind.Utc).AddTicks(1215),
                            Name = "Locke Burger",
                            StartTime = new DateTime(2023, 6, 2, 10, 3, 53, 961, DateTimeKind.Utc).AddTicks(1213)
                        });
                });
            ...
            modelBuilder.Entity("Lunch_Tinder.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$T0H6e5kcJ8mtvIsj82UNbOuM1wxz0BofNXAlQ4KAE5JjQFQjmScPS",
                            UserName = "Test",
                            UserType = "USER"
                        },
                        new
                        {
                            ...
                            Password = "$2a$11$afYjpOPoFDpSJA/VnyVtEer0qeO5wHh9socqLJEMn1d/bHUsakPLa",
                            UserName = "Test",
                            UserType = "ADMIN"
                        });
                });
