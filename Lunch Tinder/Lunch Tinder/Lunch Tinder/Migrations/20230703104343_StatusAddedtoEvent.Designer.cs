...
namespace Lunch_Tinder.Migrations
{
    ...
    [Migration("20230703104343_StatusAddedtoEvent")]
    partial class StatusAddedtoEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lunch_Tinder.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$l0ElG/erYpkJGWGPfgG49uRWmCF3v8vYdSPGWMZnuyJ2FI0kJTtDq",
                            UserName = "Test",
                            UserType = "USER"
                        },
                        new
                        {
                            ...
                            Password = "$2a$11$nyJCea0FuDHqO1hoCGlT4.A/2333TpEDAUHgDTkO59Dmv//j9goeG",
                            UserName = "Test",
                            UserType = "ADMIN"
                        });
                });
