...
namespace Lunch_Tinder.Migrations
{
    ...
    [Migration("20230525150834_SeedDataForLogin")]
    partial class SeedDataForLogin
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lunch_Tinder.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2023, 5, 25, 15, 13, 33, 917, DateTimeKind.Utc).AddTicks(2051),
                            Name = "Locke Burger",
                            StartTime = new DateTime(2023, 5, 25, 15, 8, 33, 917, DateTimeKind.Utc).AddTicks(2049)
                        });
                });
            ...
            modelBuilder.Entity("Lunch_Tinder.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$frgfRDtgRGyPN4xfJyISTeTEq4cWBUPgkTvRfK2QeLoSbdwq8AWRC",
                            UserName = "Test",
                            UserType = "USER"
                        },
                        new
                        {
                            ...
                            Password = "$2a$11$zAwJ7jx0yYxAfLPqFu8FMuWDWT1gt.RNOK/e/odOob2HXOdJgeyq6",
                            UserName = "Test",
                            UserType = "ADMIN"
                        });
                });
