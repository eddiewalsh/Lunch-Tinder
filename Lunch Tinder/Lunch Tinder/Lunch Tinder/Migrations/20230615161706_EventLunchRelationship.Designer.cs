...
namespace Lunch_Tinder.Migrations
{
    ...
    [Migration("20230615161706_EventLunchRelationship")]
    partial class EventLunchRelationship
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Lunch_Tinder.Models.Event", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EndTime = new DateTime(2023, 6, 15, 16, 22, 5, 804, DateTimeKind.Utc).AddTicks(8496),
                            Name = "Locke Burger",
                            StartTime = new DateTime(2023, 6, 15, 16, 17, 5, 804, DateTimeKind.Utc).AddTicks(8491)
                        });
                });
            ...
            modelBuilder.Entity("Lunch_Tinder.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Password = "$2a$11$Wh0t3jRNHyZRGTsd6bO/veOwOA2hwVo3zqt7JsK8T4EB261e5ld9i",
                            UserName = "Test",
                            UserType = "USER"
                        },
                        new
